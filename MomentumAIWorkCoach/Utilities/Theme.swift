...
enum Theme {
    ...
    /// Always-dark text for use ON primaryLight backgrounds (light teal). Never use adaptive colours there.
    static let onPrimaryLight = Color(red: 0.051, green: 0.200, blue: 0.180)
