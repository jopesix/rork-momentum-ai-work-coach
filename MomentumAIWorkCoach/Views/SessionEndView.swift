...
struct SessionEndView: View {
            ...
            VStack(spacing: 28) {
                VStack(spacing: 14) {
                    ZStack {
                        ...
                        Image(systemName: "sun.max.fill").font(.system(size: 34)).foregroundStyle(Theme.primaryTeal)
                    }
                ...
                .padding(20).background(Theme.primaryLight)
    ...
    private var celebrationView: some View {
        VStack(spacing: 32) {
            ...
            if !Constants.elevenlabsAgentId.isEmpty {
                VStack(spacing: 8) {
                    ...
                    MoWidgetView(
                        ...
                        context: buildCelebrationContext()
                    )
            ...
            Button {
                onSave(pendingDone, pendingNext)
            } label: {
                Text("Done")
                    .font(.system(size: 18, weight: .semibold)).foregroundStyle(.white)
                    .frame(maxWidth: .infinity).frame(height: 56)
